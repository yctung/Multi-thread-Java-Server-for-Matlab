 ...
 */
public class MatlabMultithreadServer extends Thread {
	private static final int MAX_SERVER_CNT = 5; // number of threads being supported
	private static final String CLASS_NAME 	= MatlabMultithreadServer.class.getSimpleName();
	...
	private int port;
	private static ConcurrentHashMap<Integer, MatlabMultithreadServer> servers = new ConcurrentHashMap<Integer, MatlabMultithreadServer>(MAX_SERVER_CNT, 0.75f, MAX_SERVER_CNT);
...
//===============================================================
	...
	public static MatlabMultithreadServer create(int port){
		// TODO: check if the port of server exist
		MatlabMultithreadServer jss = new MatlabMultithreadServer(port);
	...
	// Private constructor
	private MatlabMultithreadServer(int port) {
		this.port = port;
		shutdown = false;
		serverSocket = null;
		clientSocket = null;
...
//===============================================================
	...
	public static void closeAll(){
		for (MatlabMultithreadServer server : servers.values()) {
...
//===============================================================
	public static void main(String[] args) {
		MatlabMultithreadServer.closeAll();
		...
		MatlabMultithreadServer jss = MatlabMultithreadServer.create(50005);
	}
